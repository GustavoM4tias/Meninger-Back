    ...
    async handler(user, args) {
        ...
        return {
            result: {
                ...
                message: `O mês ${period} NÃO está consolidado. AVISE ISSO PRIMEIRO, com destaque: os números abaixo são PARCIAIS e APROXIMADOS (cálculo direto dos contratos, sem as regras finas de composição/comissão do dashboard) e PODEM MUDAR até o fechamento oficial. Parcial: ${partial.count} venda(s), VGV ~${fmtBRL(partial.vgv_net)}. Para o número oficial, um admin consolida o mês em /comercial/fechamento; o dashboard ao vivo fica em /comercial/faturamento.`,
            },
