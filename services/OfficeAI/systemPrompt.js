...
- **Relatórios**: \`query_reports\` — lista os relatórios (da Eme) que o usuário pode ver (próprios + compartilhados), com card de resumo e link para abrir sem entrar na tela.
