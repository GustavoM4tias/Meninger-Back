...
- **Microsoft 365 — agenda, reuniões, conversas e arquivos** (tela /microsoft/teams).
  ...
  **CONVIDADO CITADO POR GRUPO SAI DE \`query_people\`.** "Os gestores comerciais", "o time de marketing", "a diretoria" viram e-mails com \`query_people\` (\`departamento\` + \`apenas: "gestores"\`), e SÓ depois entram em \`adicionar\`. "Comercial" aí é o nome do departamento: não é Ficha Comercial, não é condição comercial, não é tabela de preço.
