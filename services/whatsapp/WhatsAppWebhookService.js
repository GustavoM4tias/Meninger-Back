...
async function handleIncomingMessage(m, fromPhone) {
    ...
    //
    // Antes dela: cliente que recebeu aviso de parcela vencida e respondeu "SIM"
    // está pedindo a nova via - o módulo de parcelas do Ato reemite e responde
    // ele mesmo; aí a auto-resposta genérica não faz sentido.
    if (!userId && fromPhone) {
        (async () => {
            try {
