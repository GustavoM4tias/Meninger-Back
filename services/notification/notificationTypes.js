...
export const NotificationType = {
    ...
    EVENT_PLAN_STAGE_DECIDED:     'event_plan.stage_decided',
...
export const NOTIFICATION_CATALOG = {
    ...
    [NotificationType.EVENT_PLAN_STAGE_DECIDED]: {
        label: 'Etapa de autorização decidiu o plano de eventos',
        group: 'Comercial',
        description: 'Quando uma etapa de autorização decide sobre o plano (aprovações, ressalvas e cortes) e ele avança na fila, ou chega ao fim.',
        emailType: 'generic.notification',
        whatsapp: null,
        defaults: { inapp: true, email: true, whatsapp: false },
        userOptional: true,
