...
const STATEMENTS = [
  ...
  `ALTER TABLE cv_panel_settings ADD COLUMN IF NOT EXISTS api_email VARCHAR(255)`,
  `ALTER TABLE cv_panel_settings ADD COLUMN IF NOT EXISTS api_token VARCHAR(255)`,
