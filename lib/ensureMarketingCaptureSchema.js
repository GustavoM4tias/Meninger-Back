...
const STATEMENTS = [
    ...
    // Desdobramento de leads Meta: formulário × pixel (2026-07-13). Colunas
    // também estão nos models (sync alter cobre), mas o ADD COLUMN aqui garante
    // mesmo quando o gate de fingerprint pula o alter.
    ...
    // Destinatários dos alertas da captação (2026-07-20). null = nunca
    // configurado; [] = explicitamente "todos os admins". O UPDATE abaixo faz
    // o seed inicial UMA vez (só quando ainda null): Gustavo Diniz + Taketa.
