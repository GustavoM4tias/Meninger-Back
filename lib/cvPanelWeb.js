...
async function autenticar() {
    ...
    try {
        ...
        // 2) POST do form. `opLogin` vale "login" (lido do HTML do painel em
        // 23/09/2026); mandar "1" faz o CV devolver o formulário de novo, sem
        // dizer que recusou - o erro fica parecido com senha errada.
