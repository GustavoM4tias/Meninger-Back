...
export const RETIRED_ROUTES = [
    ...
    ['/settings/integracao-microsoft', 'tela removida em 2026-08-24: a configuração não muda e vale pelo padrão'],
    ['/settings/outlook-lab', 'laboratório removido em 2026-08-24 junto com a tela de integração'],
    ['/financeiro/recebimentos-ato', 'virou a aba Conciliação da tela Ato em 2026-08-26; quem tem o Ato já vê'],
];
