...
const STATEMENTS = [
    ...
    // Adimplência premiada também é dado do Office por unidade, e nasceu com FK
    // para cv_enterprise_units. O sync apaga e recria as unidades, a FK recusava
    // o DELETE e as unidades de 7 empreendimentos ficaram congeladas de 15/09 a
    // 23/09 (o erro só ia para o log). O model já declara constraints:false;
    // isto remove a FK de quem já a tem. Mesmo motivo das tabelas acima.
    `ALTER TABLE IF EXISTS enterprise_unit_adimplencia
         DROP CONSTRAINT IF EXISTS enterprise_unit_adimplencia_idunidade_fkey`,
];
