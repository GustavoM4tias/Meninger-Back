...
export const SCREEN_CAPABILITIES = {
    ...
    // Link de Cartão (Userede) — hoje só configuração, e configurar significa
    // mexer em credencial de adquirente e disparar login no portal: admin.
    // Quando o histórico de links entrar, ele nasce view/operate delegáveis,
    // igual ao Boleto Caixa.
    '/financeiro/link-cartao': {
        view: 'screen',
        configure: 'admin',   // credenciais Userede, tetos, série gatilho, teste de conexão
    },
