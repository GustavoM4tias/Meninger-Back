...
const FUNCIONALIDADES = [
    ...
    {
        key: 'unidades',
        // Entra em MODO ESCUTA: o que interessa aqui é descobrir se o CV manda
        // o MOTIVO do bloqueio no aviso. Nenhuma API dele entrega esse campo e
        // a tela do painel está atrás de CAPTCHA, então o webhook é a única
        // chance de manter o estoque comercial em dia sozinho. Enquanto o
        // payload não for conhecido, processar seria chutar.
        processa: false,
        descricao: 'Unidades - cadastro, alteração e mudança de situação. Em escuta: procurando o motivo do bloqueio para o estoque comercial.',
    },
];
