...
const STATEMENTS = [
    ...
    // Janela de funcionamento (08:00-20:00 Brasília por padrão)
    `ALTER TABLE boleto_settings ADD COLUMN IF NOT EXISTS janela_ativa BOOLEAN NOT NULL DEFAULT TRUE`,
    `ALTER TABLE boleto_settings ADD COLUMN IF NOT EXISTS janela_inicio_hora INTEGER DEFAULT 8`,
    `ALTER TABLE boleto_settings ADD COLUMN IF NOT EXISTS janela_fim_hora INTEGER DEFAULT 20`,
