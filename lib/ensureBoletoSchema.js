...
const PATCHES_UNICOS = [
    ...
    {
        // 08/09/2026 (noite, Gustavo): o Sienge SAI do criterio de encerramento -
        // ter contrato ou titulo no ERP nao prova que ele cobra as mensais (o
        // titulo pode ser adiantamento). So a etapa do repasse no CV encerra.
        // Os planos pausados na ativacao "por ter titulo" voltam a ativo, EXCETO o
        // Park Alameda Sarandi, que esta parado por decisao da construtora e ganha
        // o mesmo motivo dos outros planos do empreendimento.
