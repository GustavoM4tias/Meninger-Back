...
export async function ensureChecklistSchema() {
    ...
    const statements = [
        ...
        // Colunas da tarefa que surgiram em rodadas de feedback (datas, categoria).
        // Sem isto, salvar prazo/contratação em uma tabela antiga falha silenciosamente.
        ...
        // Campo de valor/orçamento REMOVIDO do produto — dropa em definitivo do banco.
        `ALTER TABLE "checklist_tasks" DROP COLUMN IF EXISTS "value";`,
        `ALTER TABLE "checklist_tasks" DROP COLUMN IF EXISTS "value_kind";`,
        `ALTER TABLE "checklist_template_items" DROP COLUMN IF EXISTS "default_value";`,
