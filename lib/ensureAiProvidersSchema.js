...
const CONTEXTOS = [
    ...
    // A IA aqui NÃO encontra padrão: ela só escreve em português o padrão que
    // o código já encontrou e contou. Por isso pede um modelo barato, e não o
    // de raciocínio - ver services/processos/agrupamento.js.
    ['processos', 'Motor de processos (redação das regras propostas)', true,
        'Este contexto só redige: quem encontra o padrão e calcula a confiança é o código. Um modelo rápido e barato basta.'],
