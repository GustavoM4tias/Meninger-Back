...
const COMERCIAL = [
    ...
    '/comercial/mcmv', '/comercial/workflow/groups', '/crm/buildings', '/crm/imobiliarias',
...
const DEFAULT_PROFILE_ROUTES = {
    ...
    LEGALIZACAO: ['/crm/buildings', '/comercial/precadastros', '/validator'],
    JURIDICO: ['/comercial/conditions', '/crm/buildings', '/comercial/reservas-report', '/validator'],
