...
const FINANCEIRO = ['/financeiro/titulos', '/financeiro/custos', '/financeiro/consulta-cef'];
...
const DEFAULT_PROFILE_ROUTES = {
    ...
    JURIDICO: ['/comercial/conditions', '/crm/buildings', '/comercial/relatorios/reservas', '/validator'],
