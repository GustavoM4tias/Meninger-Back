export default (sequelize, DataTypes) => {
    ...
    const SalesStandModel = sequelize.define('SalesStandModel', {
        ...
        // Faixa de metragem do stand (m²): de/até. Máx 0 = faixa aberta ("X+").
        avg_area_min: { type: DataTypes.DECIMAL(8, 2), allowNull: false, defaultValue: 0 },
        avg_area_max: { type: DataTypes.DECIMAL(8, 2), allowNull: false, defaultValue: 0 },
